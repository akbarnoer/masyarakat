...
<body>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-5">
                <h2 class="text-center text-white mb-0 mt-5">AKBAR</h2>
                ...
                @endif
                <a href="{{ route('pekat.index') }}" class="btn btn-light text-black mt-3" style="width: 100%">Kembali ke Halaman Utama</a>
            </div>
        </div>
    </div>
</body>
